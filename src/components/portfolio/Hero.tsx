export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-end px-6 md:px-12 pt-28 pb-10 md:pb-14 relative overflow-hidden bg-linear-to-br from-[#FAFAFA] via-[#FAFAFA] to-[#F0EEE9]">
      {/* Blueprint grid */}
      ...
      <span aria-hidden="true" className="hidden md:block absolute right-12 top-1/2 -translate-y-1/2 rotate-90 text-[0.6rem] tracking-[0.3em] uppercase text-[#0D0D0D]">
        Est. 2015
      </span>

      <p className="fo-a1 text-[0.65rem] tracking-[0.28em] uppercase text-[#C8A96E] mb-5 text-center">
        Architect · Lagos, Nigeria
      </p>

      <h1 className="fo-a2 font-light leading-[0.9] tracking-[-0.02em] text-[#0D0D0D] text-center"
      ...
      <div className="fo-a3 flex flex-col md:flex-row md:justify-between md:items-end gap-6">
        ...
        <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-end gap-4 md:gap-2 shrink-0">
          <span className="text-[0.65rem] tracking-[0.2em] uppercase text-[#0D0D0D]">📍 Lagos · Nigeria</span>
          <div className="hidden md:flex flex-col items-center gap-1">
            <div className="fo-tick w-[0.5px] h-9 bg-[#E0DDD6]" />
            <span className="text-[0.6rem] tracking-[0.2em] uppercase text-[#0D0D0D]">Scroll</span>
          </div>
        </div>
      </div>
    </section>
